  ...
  const data = {
    ...
    return (
        <Grid className="App">
            ...
            <Github repos={repos} getLanguages={getLanguages} getCollaborators={getCollaborators}
                    githubUsername={githubUsername} languages={languages} collaborators={collaborators}/>
